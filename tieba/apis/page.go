...
func RGetForum(acc *postbar.Account, kw string, rn,
	...
	return simple_http.Post(`http://c.tieba.baidu.com/c/f/frs/page`, parameters)
...
func RGetThread(acc *postbar.Account, tid uint64, mark bool, pid uint64, pn, rn int,
	...
	return simple_http.Post(`http://c.tieba.baidu.com/c/f/pb/page`, parameters)
...
func RGetFloor(acc *postbar.Account, tid uint64,
	...
	resp, err := simple_http.Post(`http://c.tieba.baidu.com/c/f/pb/floor`, parameters)
	return resp, err
}
