...
import "github.com/purstal/go-tieba-base/simple-http"
import "github.com/purstal/go-tieba-base/misc"
...
func AddMandatoryParams(parameters *simple_http.Parameters, account *Account) {
	//AddMandatoryParams
	if account.BDUSS != "" {
...
func ProcessParams(parameters *simple_http.Parameters, account *Account) {
	//ProcessParams
	if account != nil {
